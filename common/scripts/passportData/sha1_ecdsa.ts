...
export function genMockPassportData_sha1_ecdsa(): PassportData {
...
function verify_sha1_ecdsa(passportData: PassportData): boolean {
...
const mockPassportData = genMockPassportData_sha1_ecdsa();
console.log('Passport Data:', JSON.stringify(mockPassportData, null, 2));
console.log('Signature valid:', verify_sha1_ecdsa(mockPassportData));
