...
async function buildCscaMerkleTree() {
    ...
    if (DEVELOPMENT_MODE) {
        const mockCscaList = [
            ...
            '../common/src/mock_certificates/sha256_rsapss_32_65537_4096/mock_csca.pem',
            '../common/src/mock_certificates/sha256_rsapss_32_3_4096/mock_csca.pem',
            '../common/src/mock_certificates/sha256_rsapss_32_3_3072/mock_csca.pem',
            '../common/src/mock_certificates/sha256_rsapss_3072/mock_csca.pem',
            '../common/src/mock_certificates/sha384_rsapss_48_65537_3072/mock_csca.pem',
            '../common/src/mock_certificates/sha384_rsapss_48_65537_4096/mock_csca.pem',
        ];
