...
import { assembleEContent, bytesToBigDecimal, formatAndConcatenateDataHashes, formatMrz, hash, packBytes, splitToWords, toUnsignedByte } from '../../common/src/utils/utils';
...
describe("Proof of Passport - Circuits - RSASSAPSS - 2057", function () {
    ...
    function genMockPassportData_sha256WithRSASSAPSS_65537(): PassportData {
        const keypair = forge.pki.rsa.generateKeyPair(2057);
