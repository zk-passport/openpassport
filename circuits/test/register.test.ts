...
import { mockPassportData_sha256WithRSAEncryption_65537, mockPassportData_sha1WithRSAEncryption_65537 } from "../../common/src/utils/mockPassportData";
import { generateCircuitInputsRegister } from '../../common/src/utils/generateInputs';
import { getLeaf } from '../../common/src/utils/pubkeyTree';
import { packBytes } from '../../common/src/utils/utils';

describe("Proof of Passport - Circuits - Register flow - sha256WithRSAEncryption_65537", function () {
    this.timeout(0);
    let inputs: any;
    let circuit: any;
...
describe("Proof of Passport - Circuits - Register flow - sha1WithRSAEncryption_65537", function () {
    this.timeout(0);
    let inputs: any;
    let circuit: any;
