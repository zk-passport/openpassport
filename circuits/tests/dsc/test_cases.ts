...
export const fullSigAlgs = [
  ...
  { sigAlg: 'rsa', hashFunction: 'sha1', domainParameter: '3', keyLength: '4096' }, // does't have a dsc
  ...
  { sigAlg: 'rsapss', hashFunction: 'sha256', saltLen: '32', domainParameter: '65537', keyLength: '2048' },
  ...
  { sigAlg: 'rsapss', hashFunction: 'sha256', saltLen: '32', domainParameter: '3', keyLength: '4096' }, // does't have a dsc
  { sigAlg: 'rsapss', hashFunction: 'sha384', saltLen: '48', domainParameter: '65537', keyLength: '3072' },
  { sigAlg: 'rsapss', hashFunction: 'sha384', saltLen: '48', domainParameter: '65537', keyLength: '4096' }, // does't have a dsc
  { sigAlg: 'ecdsa', hashFunction: 'sha1', domainParameter: 'secp256r1', keyLength: '256' },
  { sigAlg: 'ecdsa', hashFunction: 'sha1', domainParameter: 'brainpoolP256r1', keyLength: '256' }, // does't have a dsc
