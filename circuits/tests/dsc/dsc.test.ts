...
import {
  ...
  mock_dsc_sha256_rsapss_32_65537_2048,
  mock_dsc_sha256_rsapss_32_65537_3072,
  mock_dsc_sha256_rsapss_32_65537_4096,
  mock_dsc_sha256_rsapss_32_3_3072,
  mock_dsc_sha256_rsapss_32_3_4096,
  mock_dsc_sha384_rsapss_48_65537_2048,
  mock_dsc_sha384_rsapss_48_65537_3072
...
import { getCsca } from '../../../common/src/utils/csca';

const testSuite = process.env.FULL_TEST_SUITE === 'true' ? fullSigAlgs : sigAlgs;

testSuite.forEach(({ sigAlg, hashFunction, domainParameter, keyLength, saltLen }) => {
  describe(`DSC chain certificate - ${hashFunction.toUpperCase()} ${sigAlg.toUpperCase()} ${domainParameter.toUpperCase()} ${keyLength}`, function () {
    ...
    const algo =  sigAlg == "rsapss"
    ? `${hashFunction}_${sigAlg}_${saltLen}_${domainParameter}_${keyLength}`
    : `${hashFunction}_${sigAlg}_${domainParameter}_${keyLength}`
    
    let cscaCertPem = getCsca(algo)
    ...
    switch (algo) {
      ...
      //   break;
      case 'sha256_rsapss_32_65537_2048':
        dscCertPem = mock_dsc_sha256_rsapss_32_65537_2048;
        break;
      case 'sha256_rsapss_32_65537_3072':
        dscCertPem = mock_dsc_sha256_rsapss_32_65537_3072;
        break;
      case 'sha256_rsapss_32_65537_4096':
        dscCertPem = mock_dsc_sha256_rsapss_32_65537_4096;
        break;
      case 'sha256_rsapss_32_3_3072':
        dscCertPem = mock_dsc_sha256_rsapss_32_3_3072;
        break;
      case 'sha256_rsapss_32_3_4096':
        dscCertPem = mock_dsc_sha256_rsapss_32_3_4096;
        break;
      case 'sha384_rsapss_48_65537_3072':
        dscCertPem = mock_dsc_sha384_rsapss_48_65537_3072;
        break;
      case 'sha384_rsapss_48_65537_4096':
        dscCertPem = mock_dsc_sha384_rsapss_48_65537_2048;
        break;
