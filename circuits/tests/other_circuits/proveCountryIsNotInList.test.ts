...
describe('ProveCountryIsNotInList', function () {
    ...
    describe('ProveCountryIsNotInList', async () => {
        ...
        it('should succeed', async () => {
            ...
            const forbidden_countries_list_packed = (await circuit.getOutput(witness, ['forbidden_countries_list_packed[2]']))
            console.log('\x1b[34m%s\x1b[0m', 'forbidden_countries_list_packed', formatAndUnpackForbiddenCountriesList(forbidden_countries_list_packed));
        });
