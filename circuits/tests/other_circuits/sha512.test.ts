...
describe('sha512', function () { 
    ...
    before(async () => {
        circuit = await wasm_tester(
          path.join(
            __dirname,
            `../../circuits/tests/utils/sha512_tester.circom`
          ),
          {
            include: [
              'node_modules',
      ...
      circuitStatic = await wasm_tester(
        path.join(
          __dirname,
          `../../circuits/tests/utils/sha512_static_tester.circom`
        ),
        {
          include: [
            'node_modules',
    ...
    it('Dynamic - should calculate the hash correcty', async function () {
      ...
      const signedAttr = [
        ...
        -122, 72, -122, -9, 13, 1, 9, 4, 49, 34, 4, 32, 51, -119, -60, -100, 83, 81, 1,
        84, -99, 0, -1, -4, -101, 45, -14, -76, 6, 49, 1, -60, -43, 22, 42, 21, 111, -96,
        97, 102, -66, 71, -43, -34, 
      ]
