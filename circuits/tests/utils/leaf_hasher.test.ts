...
import { computeLeafFromModulusBigInt, getCSCAInputs, getTBSHash, leafHasherLight } from '../../../common/src/utils/csca';
...
describe('LeafHasher Light', function () {
    ...
    this.beforeAll(async () => {
        const circuitPath = path.resolve(__dirname, '../../circuits/tests/utils/leafHasherLight_tester.circom');
