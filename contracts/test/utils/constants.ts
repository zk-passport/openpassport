...
export const CIRCUIT_CONSTANTS = {
    ...
    VC_AND_DISCLOSE_CURRENT_DATE_INDEX: 3,
    VC_AND_DISCLOSE_FORBIDDEN_COUNTRIES_LIST_PACKED_INDEX: 4,
    VC_AND_DISCLOSE_NULLIFIER_INDEX: 5,
    VC_AND_DISCLOSE_MERKLE_ROOT_INDEX: 6,
    VC_AND_DISCLOSE_SMT_ROOT_INDEX: 7,
    VC_AND_DISCLOSE_SCOPE_INDEX: 8,
    VC_AND_DISCLOSE_USER_IDENTIFIER_INDEX: 9,
}
