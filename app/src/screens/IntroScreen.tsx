...
const IntroScreen = () => {
  ...
  const isButtonDisabled = input.length <= 1;

  return (
    <ScrollView flex={1}>
      <YStack px="$4" f={1} mb="$4" minHeight="100%" pb="$6">
        <YStack flex={1} mx="$2" gap="$5">
          ...
          {sivUserID
            ? <XStack alignItems='center' mt="$5" bg={componentBgColor} borderRadius={100} borderWidth={1} borderColor={borderColor} py="$2.5" px="$3">
