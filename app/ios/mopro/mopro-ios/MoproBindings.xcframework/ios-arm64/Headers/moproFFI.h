...
void uniffi_mopro_fn_func_run(RustCallStatus *_Nonnull out_status
...
void ffi_mopro_rustbuffer_free(RustBuffer buf, RustCallStatus *_Nonnull out_status
);
RustBuffer ffi_mopro_rustbuffer_reserve(RustBuffer buf, int32_t additional, RustCallStatus *_Nonnull out_status
);
uint16_t uniffi_mopro_checksum_func_add(void
    
);
uint16_t uniffi_mopro_checksum_func_hello(void
    
);
uint16_t uniffi_mopro_checksum_func_run(void
