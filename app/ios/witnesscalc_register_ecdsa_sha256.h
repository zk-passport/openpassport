#ifndef WITNESSCALC_register_ecdsa_sha256_H
#define WITNESSCALC_register_ecdsa_sha256_H
...
#define WITNESSCALC_ERROR_SHORT_BUFFER 0x2
    ...
    int
    witnesscalc_register_ecdsa_sha256(
...
#endif // WITNESSCALC_register_ecdsa_sha256_H